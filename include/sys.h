...
extern int sys_socketcall(void);
...
extern int sys_getresuid32(void);
extern int sys_setresgid32(void);
extern int sys_getresgid32(void);
...
extern int sys_faccessat2(void);
